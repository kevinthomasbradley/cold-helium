...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Heliumcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kevinthomasbradley.com", "159.203.117.240"}, // IP Address of server TODO
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"heliumcointools.com", "testnet-seed.heliumcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Heliumcoin is probably already running."), addrBind.ToString().c_str());
        else
